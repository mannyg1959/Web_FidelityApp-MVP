    ...
    return (
        <div className="antialiased bg-background-light">
            <main className="flex-1 overflow-x-hidden">
                <section className="px-6 md:px-10 lg:px-40 py-16 lg:py-24 max-w-[1440px] mx-auto relative">
                    ...
                    <div className="flex flex-col lg:flex-row gap-16 items-center">
                        <div className="reveal-left active flex-1 space-y-8">
                            ...
                            <p className="text-xl text-text-muted dark:text-slate-400 leading-relaxed max-w-2xl mt-4 font-medium">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4">
                                <div className="space-y-4 group">
                                    ...
                                    <p className="text-text-muted text-sm font-medium leading-relaxed">Los clientes fidelizados gastan hasta un 33% más por visita que los nuevos.</p>
                                </div>
                                <div className="space-y-4 group">
                                    ...
                                    <p className="text-text-muted text-sm font-medium leading-relaxed">Recopila datos valiosos y preferencias para personalizar cada interacción.</p>
                                </div>
                            </div>
                        </div>
                ...
                <section className="reveal w-full border-t border-orange-50 py-20 bg-white">
                    <div className="px-6 md:px-10 lg:px-40 max-w-[1440px] mx-auto text-center">
                        <div className="flex flex-col items-center mb-16 space-y-4">
                            ...
                            <p className="text-text-muted text-lg max-w-2xl font-medium">Kpoint se adapta a la naturaleza de tu negocio con herramientas específicas.</p>
                        </div>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                <div key={i} className="reveal-scale group p-8 rounded-[2.5rem] bg-background-light border border-slate-100 transition-all duration-300 shadow-[0_20px_50px_rgba(0,0,0,0.15)] hover:shadow-2xl hover:shadow-orange-100 hover:-translate-y-2">
                                    <div className={`size-16 rounded-3xl ${item.bg} ${item.color} flex items-center justify-center mb-6 mx-auto transition-all group-hover:scale-110 group-hover:rotate-6`}>
                                        <span className="material-symbols-outlined text-4xl">{item.icon}</span>
                                    </div>
                                    <h4 className="font-bold text-xl text-text-main">{item.label}</h4>
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                <section id="casos-exito" className="py-24 px-6 bg-background-subtle relative overflow-hidden">
                    ...
                    <div className="max-w-[1280px] mx-auto relative z-10">
                        <div className="reveal text-center mb-16 space-y-4">
                            ...
                            <p className="text-xl text-text-muted font-medium">Resultados reales de negocios que ya usan Kpoint.</p>
                        </div>
