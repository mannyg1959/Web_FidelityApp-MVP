            ...
            {isMenuOpen && (
                <div className="fixed inset-x-0 top-[73px] z-[90] flex h-[calc(100vh-73px)] flex-col bg-white dark:bg-slate-900 p-6 md:hidden">
                    ...
                    <div className="mt-auto flex flex-col gap-4">
                        <a href="https://app.kpointve.com" className="w-full flex items-center justify-center rounded-2xl bg-slate-100 dark:bg-slate-800 py-4 font-black text-slate-700 dark:text-white">
                            Iniciar sesión
                        </a>
                        <a href="https://app.kpointve.com" onClick={() => setIsMenuOpen(false)} className="flex w-full items-center justify-center rounded-2xl bg-primary py-4 font-black text-white shadow-xl">
                            Empezar gratis
                        </a>
                    </div>
                </div>
        ...
        <div className="layout-content-container mx-auto flex max-w-[1280px] flex-col items-center gap-6 px-6 text-center md:flex-row md:justify-between md:px-12 lg:px-20">
            <div className="flex items-center">
                <img
                    src="/logo_kpoint.png"
                    alt="Kpoint"
                    className="h-[78px] w-auto transition-all duration-300 hover:scale-105"
                />
            </div>
